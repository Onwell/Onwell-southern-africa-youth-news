...
class tnews_offer_banner_widget extends WP_Widget {
        ...
        function __construct() {
            ...
            parent::__construct(
                ...
                esc_html__( 'Tnews :: Offer Banner Widget', 'tnews' ),

                // Widget description
                array(
                    'customize_selective_refresh'   => true,
                    'description'                   => esc_html__( 'Add Offer Banner Widget', 'tnews' ),
        ...
        public function form( $instance ) {
        	...
        	?>
            <p>
                <label for="<?php echo $this->get_field_id( 'banner_img_url' ); ?>"><?php _e( 'Image URL:' ,'tnews'); ?></label>
            ...
            <p>
                <label for="<?php echo $this->get_field_id( 'banner_img_url2' ); ?>"><?php _e( 'Logo URL:' ,'tnews'); ?></label>
            ...
            <p>
                <label for="<?php echo $this->get_field_id( 'banner_title' ); ?>"><?php _e( 'Banner Title:' ,'tnews'); ?></label>
            ...
            <p>
                <label for="<?php echo $this->get_field_id( 'banner_desc' ); ?>"><?php _e( 'Banner Description:' ,'tnews'); ?></label>
            ...
            <p>
                <label for="<?php echo $this->get_field_id( 'banner_phone' ); ?>"><?php _e( 'Phone Number:' ,'tnews'); ?></label>
            ...
            <p>
                <label for="<?php echo $this->get_field_id( 'button_text' ); ?>"><?php _e( 'Button Text:' ,'tnews'); ?></label>
                <input class="widefat" id="<?php echo $this->get_field_id( 'button_text' ); ?>" name="<?php echo $this->get_field_name( 'button_text' ); ?>" type="text" value="<?php echo esc_attr( $button_text ); ?>" />
            </p>
            <p>
                <label for="<?php echo $this->get_field_id( 'button_url' ); ?>"><?php _e( 'Button URL:' ,'tnews'); ?></label>

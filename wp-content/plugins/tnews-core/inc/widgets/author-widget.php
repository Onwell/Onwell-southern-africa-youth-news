...
class tnews_author_widget extends WP_Widget {
        ...
        function __construct() {
            ...
            parent::__construct(
                ...
                esc_html__( 'Tnews :: Author Widget', 'tnews' ),

                // Widget description
                array(
                    'customize_selective_refresh'   => true,
                    'description'                   => esc_html__( 'Add Author Widget', 'tnews' ),
                    'classname'                     => 'no-class',
                )
            );
        ...
        public function form( $instance ) {
        	...
        	?>
            <p>
                <label for="<?php echo $this->get_field_id( 'author_img_url' ); ?>"><?php _e( 'Image URL:' ,'tnews'); ?></label>
            ...
            <p>
                <label for="<?php echo $this->get_field_id( 'about_name' ); ?>"><?php _e( 'Author Name:' ,'tnews'); ?></label>
            ...
            <p>
                <label for="<?php echo $this->get_field_id( 'about_bio' ); ?>"><?php _e( 'Author Bio:' ,'tnews'); ?></label>
    ...
    } // Class tnews_author_widget ends here


    // Register and load the widget
    function tnews_author_load_widget() {
        register_widget( 'tnews_author_widget' );
    }
    add_action( 'widgets_init', 'tnews_author_load_widget' );
        ...
        <div class="container space-extra-bottom">
            <div class="row gy-4">
                <?php 
                    ...
                    $start_date       = tnews_meta( 'event_schedule_start' );
                    $end_date       = tnews_meta( 'event_schedule_end' );
                    $time       = tnews_meta( 'event_time' );
                    $location   = tnews_meta( 'event_laction' );
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="event-card">
                        ...
                        <div class="thumb">
                            <?php the_post_thumbnail( 'tnews_356X276' ); ?>
                        </div>
                        <?php endif; ?>
                        <div class="details">
                            ...
                            <a class="read-more-btn" href="<?php echo esc_url( get_permalink() ); ?>"><?php echo esc_html__('More Details', 'tnews'); ?> <i class="fas fa-arrow-right"></i></a>
                        </div>
                    </div>
                </div>

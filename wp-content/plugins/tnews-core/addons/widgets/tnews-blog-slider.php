 ...
 *
 */
class Tnews_Blog_Slider extends Widget_Base {

	public function get_name() {
		return 'tnewsblogslider';
	}
	public function get_title() {
		return __( 'Blog Post Slider', 'tnews' );
	}
	...
	protected function register_controls() {
        ...
        $this->add_control(
			...
			[
				...
				'options' 	=> [
					...
					'5' 		=> __( 'Style Five', 'tnews' ),
					'6' 		=> __( 'Style Six', 'tnews' ),
					'7' 		=> __( 'Style Seven', 'tnews' ),
				],
				'separator' => 'after'
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' 		=> Controls_Manager::TEXTAREA,
				'default'  	=> __( 'col-sm-6 col-xl-4', 'tnews' ),
				'rows' => 2,
			]
		);
		$this->add_control(
			...
			[
				...
				'options' 	=> [
					...
					'blog-style9' 		=> __( 'Blog Style 9', 'tnews' ),
				],
			]
		);
        $this->add_control(
		...
		$this->add_control(
			'xl_items',
			[
				'label' 		=> __( 'Desktop XL Items', 'tnews' ),
				'type' 			=> Controls_Manager::SLIDER,
				'size_units' 	=> [ '%' ],
				'range' 		=> [
					'%' 	=> [
		...
		$this->add_control(
			'ml_items',
			[
				'label' 		=> __( 'Desktop ML Items', 'tnews' ),
				'type' 			=> Controls_Manager::SLIDER,
				'size_units' 	=> [ '%' ],
				'range' 		=> [
					'%' 	=> [
	...
	protected function render() {
		...
		//Slider Control
		$all_items = $settings['all_items'] ? $settings['all_items']['size'] : '4';
		$xl_items = $settings['xl_items'] ? $settings['xl_items']['size'] : '4';
		$ml_items = $settings['ml_items'] ? $settings['ml_items']['size'] : '3';
		$lg_items = $settings['lg_items'] ? $settings['lg_items']['size'] : '3';
		$md_items = $settings['md_items'] ? $settings['md_items']['size'] : '2';
		$sm_items = $settings['sm_items'] ? $settings['sm_items']['size'] : '2';

		//Blog post elements
		$blog_col_class = $settings['blog_col_class'] ? $settings['blog_col_class'] : 'col-sm-6 col-xl-4';
		...
		if( $settings['layout_style'] == '2' ){
			require dirname( __FILE__ ) . '/views/blog-slider/blog-slider-2.php';
		}elseif( $settings['layout_style'] == '3' ){
			require dirname( __FILE__ ) . '/views/blog-slider/blog-slider-3.php';
		}elseif( $settings['layout_style'] == '4' ){
			require dirname( __FILE__ ) . '/views/blog-slider/blog-slider-4.php';
		}elseif( $settings['layout_style'] == '5' ){
			require dirname( __FILE__ ) . '/views/blog-slider/blog-slider-5.php';
		}elseif( $settings['layout_style'] == '6' ){
			require dirname( __FILE__ ) . '/views/blog-slider/blog-slider-6.php';
		}elseif( $settings['layout_style'] == '7' ){
			require dirname( __FILE__ ) . '/views/blog-slider/blog-slider-7.php';
		}else{
			require dirname( __FILE__ ) . '/views/blog-slider/blog-slider-1.php';
		}

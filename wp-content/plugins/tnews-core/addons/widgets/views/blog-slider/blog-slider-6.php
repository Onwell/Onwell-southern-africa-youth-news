...
echo '<div class="col-auto">';
    echo '<div class="sec-btn">';
        echo '<div class="icon-box">';
            echo '<button data-slick-prev="#blog-slide7" class="slick-arrow default"><i class="far fa-arrow-left"></i></button>';
            echo '<button data-slick-next="#blog-slide7" class="slick-arrow default"><i class="far fa-arrow-right"></i></button>';
        echo '</div>';
    echo '</div>';
echo '</div>';
echo '</div>';

echo '<div class="row th-carousel" id="blog-slide7" data-slide-show="'.esc_attr($all_items).'" data-lg-slide-show="'.esc_attr($lg_items).'" data-md-slide-show="'.esc_attr($md_items).'" data-sm-slide-show="'.esc_attr($sm_items).'">';

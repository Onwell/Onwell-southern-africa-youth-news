<?php
echo '<div class="row th-carousel" data-slide-show="'.esc_attr($all_items).'" data-xl-slide-show="'.esc_attr($xl_items).'" data-ml-slide-show="'.esc_attr($ml_items).'" data-lg-slide-show="'.esc_attr($lg_items).'" data-md-slide-show="'.esc_attr($md_items).'" data-sm-slide-show="'.esc_attr($sm_items).'">';

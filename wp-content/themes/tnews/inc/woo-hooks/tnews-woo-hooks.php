...
add_filter( 'loop_shop_per_page', 'tnews_new_loop_shop_per_page', 20 );

function tnews_new_loop_shop_per_page( $product_count ) {

    if( class_exists('ReduxFramework') ) { 

        $product_count = tnews_opt( 'tnews_woo_product_perpage' );
...
add_filter('woocommerce_product_loop_start','tnews_woocommerce_product_loop_start');

function tnews_woocommerce_product_loop_start( ) {
...
add_filter('woocommerce_product_loop_end','tnews_woocommerce_product_loop_end');

function tnews_woocommerce_product_loop_end( ) {
...
add_filter('woocommerce_format_sale_price','tnews_woocommerce_format_sale_price',10,3);

function tnews_woocommerce_format_sale_price( $price, $regular_price, $sale_price ) {
...
add_filter('woocommerce_review_gravatar_size','tnews_woocommerce_review_gravatar_size');

function tnews_woocommerce_review_gravatar_size() {
...
add_filter('woocommerce_output_related_products_args','tnews_woocommerce_output_related_products_args',10,1);

function tnews_woocommerce_output_related_products_args( $args ) {

    if( class_exists('ReduxFramework') ) {

        $args['posts_per_page'] = tnews_opt('tnews_woo_relproduct_num');
...
add_filter('woocommerce_upsell_display_args','tnews_woocommerce_upsell_display_args',10,1);

function tnews_woocommerce_upsell_display_args( $args ) {

    if( class_exists('ReduxFramework') ) {

        $args['posts_per_page'] = tnews_opt('tnews_woo_upsellproduct_num');
...
function woocommerce_cross_sells_total( $limit ) {
    ...
    if( class_exists('ReduxFramework') ) {
        ...
        $limit = tnews_opt('tnews_woo_crosssellproduct_num');
...
add_filter( 'woocommerce_add_to_cart_fragments', 'tnews_refresh_mini_cart_count');

function tnews_refresh_mini_cart_count($fragments){
...
add_filter( 'woocommerce_checkout_fields' , 'tnews_override_checkout_fields' );

function tnews_override_checkout_fields( $fields  ){
    ...
    $fields['billing']['billing_first_name']['placeholder'] = esc_attr__('First Name', 'tnews');
    ...
    $fields['billing']['billing_last_name']['placeholder'] = esc_attr__('Last Name', 'tnews');
    ...
    $fields['billing']['billing_company']['placeholder'] = esc_attr__('Company name (optional)', 'tnews');
    ...
    $fields['billing']['billing_phone']['placeholder'] = esc_attr__('Phone', 'tnews');
    ...
    $fields['billing']['billing_email']['placeholder'] = esc_attr__('Email address', 'tnews');
    ...
    $fields['billing']['billing_city']['placeholder'] = esc_attr__('Town / City', 'tnews');
    ...
    $fields['billing']['billing_postcode']['placeholder'] = esc_attr__('Postcode', 'tnews');
    ...
    $fields['shipping']['shipping_first_name']['placeholder'] = esc_attr__('First Name', 'tnews');
    ...
    $fields['shipping']['shipping_last_name']['placeholder'] = esc_attr__('Last Name', 'tnews');
    ...
    $fields['shipping']['shipping_company']['placeholder'] = esc_attr__('Company name (optional)', 'tnews');
    ...
    $fields['shipping']['shipping_phone']['placeholder'] = esc_attr__('Phone', 'tnews');
    ...
    $fields['shipping']['shipping_email']['placeholder'] = esc_attr__('Email address', 'tnews');
    ...
    $fields['shipping']['shipping_city']['placeholder'] = esc_attr__('Town / City', 'tnews');
    ...
    $fields['shipping']['shipping_postcode']['placeholder'] = esc_attr__('Postcode', 'tnews');
...
add_filter( 'woocommerce_default_address_fields', 'tnews_override_default_locale_fields' );

function tnews_override_default_locale_fields( $fields ) {
...
add_filter( 'woocommerce_billing_fields' , 'tnews_custom_billing_fields' );

function tnews_custom_billing_fields( $fields ) {
    ...
    $fields['billing_first_name']['placeholder'] = esc_attr__('First Name', 'tnews');
    ...
    $fields['billing_last_name']['placeholder'] = esc_attr__('Last Name', 'tnews');
    ...
    $fields['billing_company']['placeholder'] = esc_attr__('Company name (optional)', 'tnews');
    ...
    $fields['billing_phone']['placeholder'] = esc_attr__('Phone', 'tnews');
    ...
    $fields['billing_email']['placeholder'] = esc_attr__('Email address', 'tnews');
    ...
    $fields['billing_city']['placeholder'] = esc_attr__('Town / City', 'tnews');
    ...
    $fields['billing_postcode']['placeholder'] = esc_attr__('Postcode', 'tnews');
...
add_filter( 'woocommerce_shipping_fields' , 'tnews_custom_shipping_fields' );

function tnews_custom_shipping_fields( $fields ) {
    ...
    $fields['shipping_first_name']['placeholder'] = esc_attr__('First Name', 'tnews');
    ...
    $fields['shipping_last_name']['placeholder'] = esc_attr__('Last Name', 'tnews');
    ...
    $fields['shipping_company']['placeholder'] = esc_attr__('Company name (optional)', 'tnews');
    ...
    $fields['shipping_phone']['placeholder'] = esc_attr__('Phone', 'tnews');
    ...
    $fields['shipping_email']['placeholder'] = esc_attr__('Email address', 'tnews');
    ...
    $fields['shipping_city']['placeholder'] = esc_attr__('Town / City', 'tnews');
    ...
    $fields['shipping_postcode']['placeholder'] = esc_attr__('Postcode', 'tnews');
...
add_action('woocommerce_before_main_content','tnews_shop_col_start_cb');



// Shop column end wrapper hook

add_action('woocommerce_after_main_content','tnews_shop_col_end_cb',10);



// shop main content hook

add_action('tnews_shop_main_content','tnews_shop_main_content_cb',10);



// shop main content end hook

add_action('tnews_shop_main_content_end','tnews_shop_main_content_end_cb',10);



// tnews woocommerce pagination hook

add_action('woocommerce_after_shop_loop','tnews_woocommerce_pagination',10);



// tnews woocommerce filter wrapper hook

add_action('woocommerce_before_shop_loop','tnews_woocommerce_filter_wrapper',20);



// tnews woocommerce product content wrapper

add_action('tnews_woocommerce_product_content', 'tnews_woocommerce_tab_content_wrapper_start', 10 );

add_action('tnews_woocommerce_product_content', 'tnews_grid_tab_content_cb', 10 );

add_action('tnews_woocommerce_product_content', 'tnews_list_tab_content_cb', 20 );

add_action('tnews_woocommerce_product_content', 'tnews_woocommerce_tab_content_wrapper_end', 30 );



// tnews woocommerce get sidebar

add_action('woocommerce_sidebar','tnews_woocommerce_get_sidebar',10);
...
// tnews shop loop product thumbnail hook

add_action( 'woocommerce_before_shop_loop_item', 'tnews_loop_product_thumbnail', 10 );



// tnews shop loop hozrizontal product thumbnail hook

add_action( 'woocommerce_before_shop_horizontal_loop_item', 'tnews_loop_horiontal_product_thumbnail', 10 );



// tnews shop loop horizontal product summary hook

add_action('tnews_woocommerce_shop_three_loop_product_summary','tnews_woocommerce_shop_three_loop_product_summary_cb',10);
...
add_action('woocommerce_before_single_product_summary', 'tnews_woocommerce_before_single_product_summary',10);



// single product title

add_action('woocommerce_single_product_summary', 'tnews_woocommerce_single_product_title', 30 );



// single product price and rating

add_action('woocommerce_single_product_summary', 'tnews_woocommerce_single_product_price_rating', 20 );



// single product excerpt

add_action('woocommerce_single_product_summary', 'tnews_woocommerce_single_product_excerpt', 40 );



// single product availability

add_action( 'woocommerce_single_product_summary', 'tnews_woocommerce_single_product_availability', 50 );



// single product add to cart button

add_action('woocommerce_single_product_summary','tnews_woocommerce_single_add_to_cart_button',60);



// single product meta hook

add_action('woocommerce_single_product_summary','tnews_woocommerce_single_meta',80);



// single product sidebar

add_action('tnews_woocommerce_single_product_sidebar','tnews_woocommerce_single_product_sidebar_cb');
...
add_action('tnews_quickview_before_single_product_summary','tnews_woocommerce_before_single_product_summary',10);



// single product price and rating

add_action('tnews_quickview_single_product_summary','tnews_woocommerce_single_product_price_rating',20);



// single product title

add_action('tnews_quickview_single_product_summary','tnews_woocommerce_quickview_single_product_title',30);



// single product excerpt

add_action('tnews_quickview_single_product_summary','tnews_woocommerce_single_product_excerpt',40);



// single product add to cart button

add_action('tnews_quickview_single_product_summary','tnews_woocommerce_single_add_to_cart_button',60);
...
add_action('woocommerce_review_before_comment_meta','tnews_woocommerce_reviewer_meta',10,1);
...
add_action('woocommerce_proceed_to_checkout','tnews_woocommerce_button_proceed_to_checkout',20);



// cross sell products

add_action('woocommerce_after_cart','tnews_woocommerce_cross_sell_display',10);



// mini cart view cart button

add_action('woocommerce_widget_shopping_cart_buttons','tnews_minicart_view_cart_button',10);



// mini cart checkout button

add_action('woocommerce_widget_shopping_cart_buttons','tnews_minicart_checkout_button',20);
...
// tnews woocommerce checkout login form

add_action('woocommerce_before_checkout_form','tnews_woocommerce_before_checkout_form',10);
...
add_filter( 'wooscp_button_html', 'tnews_wooscp_button_html', 10, 2 );

function tnews_wooscp_button_html( $output , $prodid ) {
...
add_filter( 'wooscp_button_text_added', 'tnews_woo_compare_btn_text_added', 10, 2 );

function tnews_woo_compare_btn_text_added( ){
...
add_filter( 'wooscp_button_text', 'tnews_compare_btn_text', 10, 2 );

function tnews_compare_btn_text(){
...
add_filter( 'woosq_button_html', 'tnews_woosq_button_html', 10, 2 );

function tnews_woosq_button_html( $output , $prodid ) {

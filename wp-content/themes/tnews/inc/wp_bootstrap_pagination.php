...
function tnews_pagination( $args = array() ) {
    ...
    $defaults = array(
        'range'           => 4,
        'custom_query'    => FALSE,
        'previous_string' => esc_html__( '&laquo;', 'tnews' ),
        'next_string'     => esc_html__( '&raquo;', 'tnews' ),
        'before_output'   => '',
        'after_output'    => ''
    );
    ...
    $args = wp_parse_args( 
        $args, 
        apply_filters( 'tnews_pagination_defaults', $defaults )
    );

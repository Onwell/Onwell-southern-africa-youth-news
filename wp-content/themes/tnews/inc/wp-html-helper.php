...
// image default alt
if( !function_exists( 'tnews_img_default_alt' ) ){
	function tnews_img_default_alt( $url = '' ){
...
// Image Tag
if( !function_exists( 'tnews_img_tag' ) ){
	function tnews_img_tag( array $args ){
...
// Anchor Tag
if( !function_exists( 'tnews_anchor_tag' ) ){
	function tnews_anchor_tag( array $args ){
...
// Heading Tag
if( !function_exists( 'tnews_heading_tag' ) ){
	function tnews_heading_tag( array $args ){
...
// Paragraph Tag
if( !function_exists( 'tnews_paragraph_tag' ) ){
	function tnews_paragraph_tag( array $args ){
...
// Other Tag
if( !function_exists( 'tnews_span_tag' ) ){
	function tnews_span_tag( array $args ){
